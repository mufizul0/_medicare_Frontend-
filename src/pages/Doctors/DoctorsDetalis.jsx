...
const DoctorsDetalis = () => {
  ...
  return (
    <section>
      <div className="max-w-[1170px] px-5 max-auto ms-72">
            ...
            <div className=" flex items-center gap-5">
              ...
              <div>
                ...
                <div className=" flex items-center gap-[16px]  ">
                  <span className="  flex items-center gap-[16px]               text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor ">
                    <img src={startIcon} alt="" /> 4.8
                  </span>
                  <span className="[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor font--[400]">
                    (272)
                  </span>
                </div>
