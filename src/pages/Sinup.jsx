...
const Sinup = () => {
  ...
  const handleFileInputChange = async (event) => {
    ...
    // later we will use clodinary to upload images 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 ">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10 " >
            ...
            <from onSubmit={submitHandler} >
              ...
              <div className="mt-7 ">
                <button type="submit" className=" w-full bg-primaryColor text-[18px] leading-[30px] rounded-lg  px-4 py-3 text-white  ">Sign Up
                </button>
              </div>
